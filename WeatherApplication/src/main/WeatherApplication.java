package main;
import weatherProvider.TemperatureDataOutOfRangeException;
...
public class WeatherApplication {
	...
	public static void printWeather() {
      ...
      }catch(TemperatureDataOutOfRangeException err){
			System.out.printf("We are sorry!\nThe data is unavailable!\n\n");
			}
       System.out.printf("############################");
    }
